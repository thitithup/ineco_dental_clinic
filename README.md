...
5. **ระบบเตรียมข้อความแจ้งเตือนคนไข้ล่วงหน้า (Appointment Reminder Service):**
   - ดึงคิวนัดหมายของวันพรุ่งนี้ (หรือวันที่ระบุ) พร้อมสร้างข้อความแจ้งเตือนสำหรับส่งทาง SMS หรือ LINE ทันที
   - ติดตามสถานะการติดต่อ (`PENDING`, `SENT`, `CONFIRMED`) ลดปัญหาการลืมนัด (No-show) ได้อย่างมีประสิทธิภาพ
